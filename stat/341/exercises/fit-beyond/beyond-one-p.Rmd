...
For the dnorm, it gives the density for mean = 0 and sd = 0.1 

For the rnorm, it generates random deviates.
...
The part that tells about the prior is the third one. 
