...
Calculations of the join likelihood will work much better if we find the **sum** of the log-likelihoods. To get back to the regular likelihood at the end we can do $e^{ln(\mathcal{L})}$ to get $\mathcal{L}$.
...
$$\text{annual_income_i} \sim \text{Normal}(\mu, \sigma)$$
